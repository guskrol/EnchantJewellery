...
Current quarantine build: `v0.1.19-exact-widget-sequence`.
...
- opens `Jewellery Enchantments` through widget `218.15` and selects `Lvl-1 Enchant` through widget `218.16`;
